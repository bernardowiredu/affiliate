    ...
    <div class="container">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top ">
       ...
       <ul class="nav">
        ...
        <li><a class="txt" href="">Samsung</a></li>
        </div>
       <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""><i class="glyphicon glyphicon-phone red"></i> Htc</a></li>
        </div>
        <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""><i class="glyphicon glyphicon-phone yellow"></i> Apple</a></li>
        </div>
        <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href="">Blackberry</a></li>
        </div>
        <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""> <i class="glyphicon glyphicon-phone blue"></i> ZTE</a></li>
        </div>
        <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href="">Motorola</a></li>
        </div>
        <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""><i class="glyphicon glyphicon-phone green"></i> Huawei</a></li>
        </div>
          <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""><i class="glyphicon glyphicon-phone red"></i> Nokia</a></li>
        </div>
          <div class="col-sm-1 col-md-1 line2">
        <li><a class="txt" href=""><i class="glyphicon glyphicon-phone blue"></i> LG</a></li>
        </div>
          <div class="col-sm-1 col-md-1 line2">
        <li>
         <li><a class="txt" href=""><i class="glyphicon glyphicon-phone yellow"></i>Sony</a></li>
...
<!-- ******************************************************************************************************************* -->
  ...
  <div class="well well-sm ">
      <h4 class="yellow">Popular Networks Unlocked</h4>
     </div>
  ...
  <div class="well well-lg">
      <div class="inline">
       ...
       <li><a href=""><h4 class="yellow">Supported payment methods</h4></a></li>
        <ul class="nav">
          <li><img class="img-responsive" src="img/mtn.jpg" width="50" height="30"> Mtn mobile money</li><p></p>
          <li><img class="img-responsive" src="img/airtel.jpg" width="50" height="40"> Airtel money</li><p></p>
          <li><img class="img-responsive" src="img/Tigo-Cash-logo.jpg" width="50" height="40"> Tigo cash</li>
        </ul>
         </div>
         </ul>
        </div>
