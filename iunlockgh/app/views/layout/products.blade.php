  ...
  <div id="fb-root"></div>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top">
       ...
       <br><br><p></p>
       <div id="call1" class="well well-sm me txt-shadow">
       <div class="row">
       <ul class="nav">
...
<div class="nav"><!-- blk -->
  ...
  @yield('content')
   ...
   <h4 class="yellow"><i>Start unlocking here</i></h4>
...
<!-- ******************************************************************************************************************* -->
  ...
  <div class="nav">
    ...
    <div class="panel-body">
      <i class="glyphicon glyphicon-comment blue"></i>Alerts don't have default classes, only base and modifier classes. A default gray alert doesn't make too much sense, so you're required to specify a type via contextual class. Choose from success, info, warning, or danger.
    </div>
  ...
  <div class="well well-lg">
      <div class="inline">
       ...
       <li><a href=""><h4 class="yellow">Supported payment methods</h4></a></li>
        <ul class="nav">
          <li><img class="img-reponsive" src="../public/img/mtn.jpg" width="50" height="30"> Mtn mobile money</li><p></p>
          <li><img class="img-reponsive" src="../public/img/airtel.jpg" width="50" height="40"> Airtel money</li><p></p>
          <li><img class="img-reponsive" src="../public/img/Tigo-Cash-logo.jpg" width="50" height="40"> Tigo cash</li>
        </ul>
         </div>
         </ul>
        </div>
